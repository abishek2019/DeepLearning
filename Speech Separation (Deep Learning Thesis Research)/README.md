<h2>Exploring Speech Separation with Generative Adversarial Networks (GANs)</h2><p> In this research, I performed a speech separation task using the Libri2Mix dataset. My major contributions include:<br><br> 
